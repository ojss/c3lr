...
__all__ = ['euclidean_distance', 'cosine_similarity', 'get_num_samples', 'get_prototypes', 'prototypical_loss',
           'nt_xent_loss', 'CNN_4Layer', 'Encoder', 'Decoder', 'CAE', 'Encoder4L', 'Decoder4L', 'Decoder4L4Mini',
           'CAE4L', 'get_images_labels_from_dl']
...
# Cell
def nt_xent_loss(i, j, temperature=.5):
    out = torch.cat([i, j], dim=0)
    n_samples = len(out)
    ...
    # positive similarity
    pos = torch.exp(torch.sum(i * j, dim=-1) / temperature)
