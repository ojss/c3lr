...
sys.path.append("../")
from configs import *
from . import contrastive_augmentations
get_simCLR_transform = contrastive_augmentations.get_simCLR_transform
get_chestX_transform = contrastive_augmentations.get_chestX_transform
...
class SimpleDataset:
    def __init__(self, transform, original_transform,
        ...
        self.dataset = ImageFolder(miniImageNetFullSize_path)
...
class SetDataset:
    def __init__(self, batch_size, transform):
        ...
        d = ImageFolder(miniImageNetFullSize_path)
