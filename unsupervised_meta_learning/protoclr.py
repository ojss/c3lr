...
__all__ = ['Classifier', 'get_train_images', 'WandbImageCallback', 'TensorBoardImageCallback',
           'ConfidenceIntervalCallback', 'UMAPCallback', 'UMAPClusteringCallback', 'PCACallback', 'ProtoCLR']
    ...
    def on_validation_batch_start(
        ...
        if trainer.current_epoch % self.every_n_epochs == 0:
            ...
            if self.logging_tech == "wandb":
                ...
                wandb.log(
                    {"UMAP of embeddings": fig,}, step=trainer.global_step,
                )
...
class PCACallback(pl.Callback):
    ...
    def on_validation_batch_start(
        ...
        wandb.log({"PCA of embeddings": fig}, step=trainer.global_step)
