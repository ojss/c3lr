...
srun python runner.py protoclr_ae miniimagenet "/home/nfs/oshirekar/unsupervised_ml/data/" --gamma=0.0003  --eval_support_shots=1 --log_images=True --distance='euclidean' --tau=1.0 --lr=1e-3 --inner_lr=1e-3
